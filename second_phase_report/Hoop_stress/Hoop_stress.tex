...
\begin{figure}[H]
	...
	\captionsource{Stress representation in envelope}{\cite{alam2017thesis}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=300 pt]{von_mises/min_hoop_stress.png}
	\caption{Optimal shape obtained for minimum von-Mises stress}
	\label{Optimal min von Mises} %      only if needed
\end{figure}
